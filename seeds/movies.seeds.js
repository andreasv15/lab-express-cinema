...
// primero tenemos que importar la conexion a la db, que está en /db/index
require("../db/index.js");
...
const addMovies = async () => {
  try {
        // cogemos los datos y los insertamos
        await MovieModel.insertMany(movies);
        console.log("Datos añadidos a la base de datos!");
...
// para ejecutar esto, en vez de hacer npm run dev, lo hacemos con node /seeds/movies.seeds.js
